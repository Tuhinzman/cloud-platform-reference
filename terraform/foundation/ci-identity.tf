    ...
    Statement = [
      {
        ...
        # Only the workload set; deriving it means a new repository cannot be forgotten here
        # and the separately declared Collector repository is excluded by construction.
